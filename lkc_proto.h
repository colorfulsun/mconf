...
_Bool sym_tristate_within_range(struct symbol *sym,tristate tri);
_Bool sym_set_tristate_value(struct symbol *sym,tristate tri);
tristate sym_toggle_tristate_value(struct symbol *sym);
_Bool sym_string_valid(struct symbol *sym, const char *newval);
